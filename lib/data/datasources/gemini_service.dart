...
class GeminiService {
  ...
  Future<String> getSuggestion(String description) async {
    final content = [Content.text("Based on this problem description in a city context: '$description', provide a short category (e.g., Infrastructure, Environment, Waste) and a 1-sentence suggested action.")];
    try {
